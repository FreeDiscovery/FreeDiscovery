...
# -*- coding: utf-8 -*-
#
# FreeDiscovery documentation build configuration file, created by
...
version = freediscovery.__version__
# The full version, including alpha/beta/rc tags.
release = freediscovery.__version__
...
htmlhelp_basename = 'FreeDiscoverydoc'
...
latex_documents = [
  (master_doc, 'FreeDiscovery.tex', 'FreeDiscovery Documentation',
   'Grossman Labs LLC', 'manual'),
]
...
man_pages = [
    (master_doc, 'freediscovery', 'FreeDiscovery Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'FreeDiscovery', 'FreeDiscovery Documentation',
   author, 'FreeDiscovery', 'One line description of project.',
   'Miscellaneous'),
]
